...
#pragma region IMUL and SETNO/SETNC

// FIXME: These are all wrong. imul is not as simple as add and sub. These need to be re-written for optimal performance!

inline bool x86_asm_imul_setno(char a, char b, char& out) {
    bool overflow;
    asm volatile (
        "imulb %2, %1\n\t"            // imul b from a, result in a
        "movb %1, (%3)\n\t"          // Store the result in out
        "setno %0\n\t"               // Set to 1 if no overflow
        : "=r"(overflow), "+r"(a)    // output: overflow, modified a
        : "r"(b), "r"(&out)          // input: b, address of out
...
inline bool x86_asm_imul_setno(i8 a, i8 b, i8& out) {
    bool overflow;
    asm volatile (
        "imulb %2, %1\n\t"
        "movb %1, (%3)\n\t"
...
inline bool x86_asm_imul_setno(i16 a, i16 b, i16& out) {
    bool overflow;
    asm volatile (
        "imulw %2, %1\n\t"
        "movw %1, (%3)\n\t"
...
inline bool x86_asm_imul_setno(i32 a, i32 b, i32& out) {
    bool overflow;
    asm volatile (
        "imull %2, %1\n\t"
        "movl %1, (%3)\n\t"
...
inline bool x86_asm_imul_setno(i64 a, i64 b, i64& out) {
    bool overflow;
    asm volatile (
        "imulq %2, %1\n\t"
        "movq %1, (%3)\n\t"
...
inline bool x86_asm_imul_setnc(u8 a, u8 b, u8& out) {
    bool carry;
    asm volatile (
        "imulb %2, %1\n\t"
        "movb %1, (%3)\n\t"
...
inline bool x86_asm_imul_setnc(u16 a, u16 b, u16& out) {
    bool carry;
    asm volatile (
        "imulw %2, %1\n\t"
        "movw %1, (%3)\n\t"
...
inline bool x86_asm_imul_setnc(u32 a, u32 b, u32& out) {
    bool carry;
    asm volatile (
        "imull %2, %1\n\t"
        "movl %1, (%3)\n\t"
...
inline bool x86_asm_imul_setnc(u64 a, u64 b, u64& out) {
    bool carry;
    asm volatile (
        "imulq %2, %1\n\t"
        "movq %1, (%3)\n\t"
