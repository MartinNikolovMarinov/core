...
i32 modf_cc_impl_compare_with_std_test() {
    {
        ...
        constexpr test_case cases[] = {
            ...
            { 0.00001f, 0.f, 0.00001f },
            { 0.49999f, 0.f, 0.49999f },
            { 0.5f, 0.f, 0.5f },

            { 7.00001f, 7.f, 0.00001f },
            { 7.49999f, 7.f, 0.49999f },
            { 7.5f, 7.f, 0.5f },

            { -0.000009f, 0.f, -0.000009f },
            { -0.4999999f, 0.f, -0.4999999f },
            { -0.5f, 0.f, -0.5f },
